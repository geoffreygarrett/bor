...
class op_addition : public metal_op_base<op_addition, 3> {
public:
    using metal_op_base<op_addition, 3>::metal_op_base;

    explicit op_addition(MTL::Device *device) : metal_op_base<op_addition, 3>(device) {
        // Initialize buffers
    ...
    static constexpr std::string get_shader_function_name() { return "op_addition"; }
